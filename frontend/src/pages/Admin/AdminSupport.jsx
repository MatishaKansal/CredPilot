...
const starterMessages = [
  {
    role: "assistant",
    content:
      "Hi! I am your CredPilot admin assistant. Ask about escalated applications, employee oversight, risk trends, reports, or platform operations.",
  },
];
...
const AdminSupport = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:8000/admin/${user.user_id}/support-chat`, {
        method: "POST",
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      <p className="text-sm font-semibold text-[#43567C]">Administrator</p>
      <h1 className="mt-1 text-2xl font-bold text-slate-950">Support Assistant</h1>
      <p className="mt-2 text-sm text-slate-500">
        Chat with AI support for escalations, oversight, risk monitoring, and reporting help.
      </p>
      ...
      <div className="mt-4 flex gap-2">
        <input
          ...
          placeholder="Ask about escalations, risk trends, or admin workflows..."
