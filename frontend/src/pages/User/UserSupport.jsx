...
const starterMessages = [
  {
    role: "assistant",
    content:
      "Hi! I am your CredPilot support assistant. Ask me about eligibility, documents, loan status, or next steps.",
  },
];
...
const UserSupport = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:8000/applicant/${user.user_id}/support-chat`, {
        method: "POST",
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "I could not fetch a response right now. Please try again in a moment or contact your loan officer.",
        },
      ]);
    } finally {
      setLoading(false);
    ...
    <div className="px-4 py-6 md:px-8">
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Chat with AI support for loan guidance and application help.
        </p>
        ...
        <div className="mt-4 flex gap-2">
          <input
            ...
            placeholder="Ask about documents, eligibility, or your application status..."
