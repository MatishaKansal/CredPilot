    ...
    <div className="space-y-5 px-4 py-6 md:px-8">
      <section className="flex flex-col gap-4 rounded-lg bg-white p-5 shadow-sm lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold text-slate-950">My Loan Applications</h1>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg bg-[#43567C] px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-900"
          >
            <Plus size={16} />
            New Application
          </button>
      ...
      <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-100 px-5 py-4">
          <h2 className="text-base font-bold text-slate-950">Application History</h2>
        </div>
              ...
              {loading ? (
                ...
                <tr>
                  <td className="px-5 py-8 text-center text-slate-500" colSpan="6">
                    ...
                    <button
                      onClick={() => navigate("/user/apply-loan")}
                      className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-[#43567C] hover:text-blue-900"
                    >
                      Start your first application <ArrowRight size={14} />
                    </button>
                  </td>
                </tr>
              )}
