...
import {
  LayoutDashboard, User, FileText, TrendingUp,
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span style={{ fontSize: 13, color: "#9ca3af", marginRight: 4 }}>
              Admin / <span style={{ color: "#1565C0", fontWeight: 500 }}>{currentPage}</span>
            </span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
              ...
              <div style={{ lineHeight: 1.3 }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: "#111827", margin: 0 }}>Suresh Agarwal</p>
