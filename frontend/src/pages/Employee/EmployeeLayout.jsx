        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span style={{ fontSize: 13, color: "#9ca3af", marginRight: 4 }}>
              Employee / <span style={{ color: "#1565C0", fontWeight: 500 }}>{currentPage}</span>
            </span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
              ...
              <div style={{ lineHeight: 1.3 }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: "#111827", margin: 0 }}>Arjun Kumar</p>
                <p style={{ fontSize: 11, color: "#9ca3af", margin: 0 }}>Loan Officer</p>
              </div>
            </div>
          </div>
        </header>
